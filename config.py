...
ADMIN = "dbgao@smu.edu.sg"
COURSE = "course.csv"
INSTRUCTOR = "instructor.csv"
SYSCONFIG = "sys_config.csv"
...
APP_NAME = "Course-Allocation"

# Uncomment to setup Setup an App icon
#APP_ICON = basedir + "/app/static/img/logo.jpg"
...
RECAPTCHA_PUBLIC_KEY = False#'GOOGLE PUBLIC KEY FOR RECAPTCHA'
RECAPTCHA_PRIVATE_KEY = False#'GOOGLE PRIVATE KEY FOR RECAPTCHA'
...
FILE_FOLDER = basedir + "/app/static/files/"
...
FAB_ROLES = {
    "Public": [#"can this form get on FillupView, can this form post on FillupView, menu access on Fillup"
        ...
        ["Fillup","menu_access"],
        ["SwitchView", "can_this_form_get"],
        ["SwitchView", "can_this_form_post"],
        ["SwitchView","menu_access"],
